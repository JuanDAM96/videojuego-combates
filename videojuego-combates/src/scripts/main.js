...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('continuarPartida').addEventListener('click', continuarPartida);
    ...
    document.getElementById('repositorio').addEventListener('click', repositorio);
});
